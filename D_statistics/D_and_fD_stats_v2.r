...
# file name for parsing chromosome and window bounds. Ignore if testing a single window in Rstudio on your own computer. 
...
output <- c(strsplit(filename_simple, "__")[[1]][1],
                strsplit(output_name, "__")[[1]][2],
                strsplit(output_name, "__")[[1]][3],
